...
function App() {
    ...
    <Container>
        ...
        <Box mt={4} pl={2} display={'flex'} alignItems='baseline' borderLeftWidth={4} borderColor={'#62605D'}>
            ...
            <Wrap spacing='40px' justify='center'>
                <WrapItem>
                    <CustomBox
                        ...
                        icon={FaSmile}
                        title={'Happiness'}
                        modalContent={'A state of well-being and contentment, fueled by positive ' +
                ...
                <WrapItem>
                    <CustomBox
                        ...
                        icon={FaBolt}
                        title={'Fear'}
                        modalContent={'A primal emotion that protects us from harm ' +
                ...
                <WrapItem>
                    <CustomBox
                        ...
                        modalContent={'The pursuit of personal growth, fulfillment, and ' +
                ...
                <WrapItem>
                    <CustomBox
                        ...
                        icon={FaHeart}
                        title={'Love'}
                        modalContent={'The powerful force that connects us, brings joy, and ' +
